from affinity.affinity_schema import get_data_by_api, post_process_data,plot_data
from langchain.tools import BaseTool, StructuredTool, Tool, tool
from affinity.affinity_schema import APICallParameters, PostProcessParameters,PlotDataParameters
import os
import io
import requests
import json
...
class PlotDataTool(BaseTool):
    name="plot_data"
    description = """
        Useful when formatting data for generating tables.
        """
    return_direct = True
    ...
    def _arun(self, **kwargs):
        raise NotImplementedError("plot_data does not support async")
